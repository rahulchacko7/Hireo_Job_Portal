        ...
        "/employer/chats": {
            "post": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Details not in correct format\" or \"User ID not found in JWT claims\" or \"Failed to get chat details",
                        "schema": {
                            "$ref": "#/definitions/response.Response"
                        }
                    }
        ...
        "/employer/schedule-interview": {
            "post": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Invalid or missing user ID\" or \"Invalid job ID\" or \"Invalid jobseeker ID\" or \"Invalid interview date\" or \"Invalid interview time\" or \"Invalid interview type",
                        "schema": {
                            "$ref": "#/definitions/response.Response"
                        }
                    },
        ...
        "/group/:groupID/chat": {
            "get": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Missing Authorization header\" or \"Invalid token\" or \"Websocket Connection Issue\" or \"Error reading WebSocket message\" or \"Details not in correct format",
                        "schema": {
                            "$ref": "#/definitions/response.Response"
                        }
                    }
        ...
        "/job-seeker/apply-saved-job": {
            "post": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Invalid or missing user ID\" or \"Invalid job ID\" or \"Error in getting resume file",
                        "schema": {
                            "$ref": "#/definitions/response.Response"
                        }
                    },
                    ...
                    "500": {
                        "description": "Failed to check saved jobs\" or \"Failed to save resume file\" or \"Failed to read resume file\" or \"Failed to apply for job",
                        "schema": {
                            "$ref": "#/definitions/response.Response"
                        }
                    }
        ...
        "/job-seeker/save-jobs": {
            "post": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Invalid or missing job ID\" or \"User ID not found\" or \"Invalid user ID type",
                        "schema": {
                            "$ref": "#/definitions/response.Response"
                        }
                    },
        ...
        "/job-seeker/saved-jobs": {
            ...
            "delete": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Invalid job ID format\" or \"Invalid or missing user ID\" or \"Invalid user ID type",
                        "schema": {
                            "$ref": "#/definitions/response.Response"
                        }
                    },
